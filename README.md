...
### v1.2.1 (2026-06-23)
- **修复子进程环境变量冲突与卡死问题**：
  - **恢复系统代理**：保留 `HTTP_PROXY` 等系统代理环境变量，以确保直连谷歌云官方 API 的 AGY 子进程可以正常连通外网。
